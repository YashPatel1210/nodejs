    ...
    stages {
        stage('Bulding Environment') {
            steps {
                ...
                ansiblePlaybook become: true,credentialsId: '8e81aba6-6340-4249-b7ff-631507eb4e9a', installation: 'Ansible', inventory: 'inventory', playbook: 'copy_files.yml',extras: '--become-pass-file pwd'
              }
            }
